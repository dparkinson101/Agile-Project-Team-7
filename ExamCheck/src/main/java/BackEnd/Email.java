...
public class Email {
    ...
    private static final String APPLICATION_NAME = "ExamCheck";
     ...
     */
    private Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException, Exception {
        // Load client secrets.
    ...
    public boolean sendEmail(String to, String from, String subject, String body) {
        ...
        try {
            ...
            MimeMessage msg = createEmail(to, from, subject, body);

            Message sentMsg = sendMessage(service, "me", msg);
